...
/**
 * TripPulse visual language: a calm, high-contrast dark theme suited to a
 * driving companion and a reassuring viewer dashboard. Teal signals "live",
 * amber signals attention, red is reserved for SOS/error.
 */
